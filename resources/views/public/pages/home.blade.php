...
<div class="jumbotron d-flex align-items-center" style="background-image: url(img/hero-2.jpg)">
    <div class="container text-center">
        ...
        <p>
            ...
            <br>Duis mollis, est non commodo luctus.
        </p>
    </div>
</div>
    ...
    <div class="container">
        <div class="section-content">
            <div class="title-wrap">
                ...
                <p class="section-sub-title">Praesent commodo cursus magna, vel scelerisque nisl consectetur et. Nulla vitae elit libero, a
                    <br> pharetra augue. Donec id elit non mi porta gravida at eget metus.</p>
            </div>
                ...
                <div class="col-md-12 text-center">
                    ...
                    <b>Brand new</b> social media,<br> different than any other one
                        ...
                        <p class="section-sub-title">
                            Praesent commodo cursus magna, vel scelerisque nisl consectetur et. Nulla vitae elit libero, a
